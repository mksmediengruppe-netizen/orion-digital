...
@app.route("/api/admin/memory/<memory_id>", methods=["DELETE"])
@require_auth
@require_admin
...
@app.route("/api/admin/memory", methods=["POST"])
@require_auth
@require_admin
...
@app.route("/api/admin/memory/clear-sessions", methods=["POST"])
@require_auth
@require_admin
