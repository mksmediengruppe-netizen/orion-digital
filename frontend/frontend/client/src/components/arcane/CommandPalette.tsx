  ...
  return (
    <>
      <CommandDialog
        ...
        description="Быстрый доступ ко всем функциям ARCANE"
      >
        ...
        <CommandList>
          ...
          <CommandGroup heading="Модель агента">
            {[
              { key: "mini", label: "Быстрый — GPT-5 Mini", icon: <Zap size={12} className="text-amber-500" /> },
              ...
              { key: "premium", label: "Премиум — Sonnet 4.6 + всё включено", icon: <Crown size={12} className="text-rose-500" /> },
            ].map(m => (
      ...
      <div className="relative bg-white rounded-2xl shadow-2xl border border-[#E8E6E1] w-full max-w-md mx-4 overflow-hidden">
        <div className="flex items-center gap-3 px-5 py-4 border-b border-[#E8E6E1]">
          ...
          <div>
            ...
            <div className="text-xs text-gray-500">ARCANE keyboard shortcuts</div>
          </div>
